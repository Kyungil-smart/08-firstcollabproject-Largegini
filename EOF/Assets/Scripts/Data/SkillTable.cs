...
// 작성자 : 한성우
// SkillData 에서 원하는 값을 쉽게 찾도록 딕셔너리 형태로 관리하는 스크립트


public class SkillTable : IDataTableInfo
{
    // 딕셔너리로 받기
    ...
    public bool LoadCSVFile(string path)
    {
        ...
        foreach (var row in dataList)
        {
            ...
            if (!SkillDic.ContainsKey(newSkill.SkillID)) SkillDic.Add(newSkill.SkillID, newSkill);

            // ID 중복이면 에러 뱉기
            else Debug.LogError($"{newSkill.SkillID}가 중복입니다.");
        }
